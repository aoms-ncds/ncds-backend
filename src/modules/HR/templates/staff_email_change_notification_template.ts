...
const staffEmailChangeNotificationTemplate = (staff: IStaff, previousEmail: string, newEmail: string) => ({
  ...
  <br/>
  We hope this email finds you well. We are writing to inform you that the email address associated with your account at Navjeevan Community Development Society has been successfully updated.<br/>
  <br/>
  ...
  <br/>
  1. Use a strong, unique password for your Navjeevan Community Development Society account.<br/>
  ...
  <br/>
  Thank you for being a valued member of Navjeevan Community Development Society.<br/>
  <br/>
  Best regards,<br/>
